  ...
  return(
    ...
    <div style={{display: 'flex', flexDirection: 'column', width: '50%', margin: '0 auto'}}>
      <div style={{display: 'flex', marginTop: 20}}>
        <img src={props.book.bookClass.picture} alt='' height='400px' />
        <div style={{marginLeft: 20}} className="flex-col">
          ...
          <div style={{marginTop: 50}} className="flex-col">
              <div className="flex-row">
                  <Typography color="textSecondary" style={{marginRight: 5}}>Category: </Typography>
                  <Typography>{props.book.bookClass.category}</Typography>
              </div>
              <div className="flex-row">
                  <Typography color="textSecondary" style={{marginRight: 5}}>Location: </Typography>
